        ...
        if (defaultPrefs.hasOwnProperty(key)) {
          ...
          if (editor.storage) {
            ...
            var result = document.cookie.match(
              new RegExp(
                "(?:^|;\\s*)" +
                  Utils.preg_quote(encodeURIComponent(storeKey)) +
                  "=([^;]+)"
              )
            );
    ...
    editor.init = function () {
      ...
      (function () {
        ...
        if (!$.isEmptyObject(urldata)) {
          ...
          $.each(
            ["extPath", "imgPath", "langPath", "jGraduatePath"],
            function (pathConfig) {
      ...
      $.svgIcons(curConfig.imgPath + "svg_edit_icons.svg", {
        ...
        callback: function (icons) {
          ...
          //editor.setIconSize(size || ($(window).height() < min_height ? 's': 'm'));//ORIGINAL
          //GOL: added check on synoptic's buttons length to get correct buttons' size in editor.
          editor.setIconSize(
            size ||
              ($(window).height() < min_height &&
              $(".synoptic_button").length > 10
                ? "s"
                : "m")
          );
          ///////////////////////////////////////////////////////////////////////////////////////
      ...
      (function () {
        ...
        var box = $("#dialog_box"),
          ...
          dbox = function (
            ...
            //GOL: dialogProperties management in synoptic.editor.main.js.
            if (
              $("#tool_make_link").attr("data-custom-typeProperties") ==
                "true" &&
              defaultVal == "http://"
            ) {
              var synopticObjId = $("#elem_id").val();
              var synopticObjTypeName = $("#" + synopticObjId).attr(
                "type_name"
              );
              ...
              $("#dialog_container").removeClass("dialogBox-customSize");
              ...
              dialog_content.removeClass("dialogContent-customSize");
            }
            //////////////////////////////////////////////////////////////
      ...
      var populateLayers = function () {
        ...
        while (layer--) {
          ...
          var layerTr = $('<tr class="layer">').toggleClass(
            "layersel",
            name === currentLayerName
          );
          var layerVis = $('<td class="layervis">').toggleClass(
            "layerinvis",
        ...
        $("#layerlist td.layervis").click(function () {
          ...
          var name = $(
            "#layerlist tr.layer:eq(" + row + ") td.layername"
          ).text();
      ...
      var toolButtonClick = (editor.toolButtonClick = function (
        button,
        noHiding
      ) {
      ...
      var updateToolbar = function () {
        ...
        if (selectedElement != null) {
          switch (selectedElement.tagName) {
            ...
            default:
              ...
              var attr =
                selectedElement.getAttribute("stroke-linejoin") || "miter";
        ...
        if (selectedElement != null) {
          ...
          $("#cell_id").val(selectedElement.getAttribute("class"));
        }
      ...
      var updateContextPanel = function () {
        ...
        $(
          "#selected_panel, #multiselected_panel, #g_panel, #rect_panel, #circle_panel, #elem_cell_id" +
        ...
        if (elem != null) {
          ...
          if (panels[el_name]) {
            ...
            if (el_name == "text") {
              ...
              //GOL: added check for synoptic's object.
              if ($(elem).attr("type_custom") == "1") {
          ...
          $("#multiselected_panel").show(); //ORIGINAL
          //GOL: disable action during multilselection of objects.
      ...
      $.each(color_blocks, function () {
        str +=
          '<div class="color_block" style="background-color:' +
          this +
          ';"></div>';
      });
      ...
      $("#selLayerNames").change(function () {
        ...
        var confirmStr = uiStrings.notification.QmoveElemsToLayer.replace(
          "%s",
          destLayer
        );
      ...
      (function () {
        ...
        $(window)
          ...
          .mousedown(function (evt) {
            //					$('.contextMenu').hide();
            var islib = $(evt.target).closest(
              "div.tools_flyout, .contextMenu"
            ).length;
            if (!islib) {
          ...
          function () {
            ...
            if (sel.val() === "JPEG" || sel.val() === "WEBP") {
              if (!$("#image-slider").length) {
                $(
                  '<div><label>Quality: <input id="image-slider" type="range" min="1" max="100" value="92" /></label></div>'
      ...
      var savePreferences = (editor.savePreferences = function () {
        // Set background
        var color =
          $("#bg_blocks div.cur_background").css("background-color") || "#FFF";
      ...
      var blurTest = svgdocbox.createElementNS(
        svgedit.NS.SVG,
        "feGaussianBlur"
      );
      ...
      $("#layer_new").click(function () {
        ...
        $.prompt(
          ...
          function (newName) {
            ...
            //GOL: add synoptic's custom layer attributes (using a custom function in synoptic.editor.main.js).
            setSynopticLayer(newName, false);
            ///////////////////////////////////////////////////////////////////////////////////////////////////
          }
        );
      });
      ...
      function cloneLayer() {
        var name =
          svgCanvas.getCurrentDrawing().getCurrentLayerName() + " copy";
      ...
      //GOL: remove default layer and add synoptic's base layer.
      svgCanvas.createLayer("Base");
      populateLayers();
      updateContextPanel();
      ...
      Actions = (function () {
        ...
        var tool_buttons = [
          ...
          //{sel: '#tool_clear', fn: clickClear, evt: 'mouseup', key: ['N', true]},//ORIGINAL
          //GOL: custom clear management in synoptic.editor.main.js.
          {
            sel: "#tool_clear",
            fn: function () {
              dialogClear(function (clear) {
                if (clear) {
                  var dims = curConfig.dimensions;
          ...
          //{sel: '#tool_save', fn: function() { if (editingsource) { saveSourceEditor();}else { clickSave();} }, evt: 'mouseup', key: ['S', true]},//ORIGINAL
          //GOL: custom save management in synoptic.editor.main.js.
          {
            sel: "#tool_save",
            fn: function () {
              saveManagement();
          ...
          //GOL: custom saveAs management in synoptic.editor.main.js.
          {
            sel: "#tool_saveAs",
            fn: function () {
              dialogSaveAs();
          ...
          //{sel: '#tool_open', fn: clickOpen, evt: 'mouseup', key: ['O', true]}, //ORIGINAL
          //GOL: custom open management in synoptic.editor.main.js.
          {
            sel: "#tool_open",
            fn: function () {
              dialogLoad();

		...
		editor.init = function () {
			...
			$.svgIcons(curConfig.imgPath + 'svg_edit_icons.svg', {
				...
				callback: function(icons) {
					...
					editor.setIconSize(size || (($(window).height() < min_height && $(".synoptic_button").length > 10) ? 's' : 'm'));
                    ///////////////////////////////////////////////////////////////////////////////////////
			...
			(function() {
				...
				var box = $('#dialog_box'),
					...
					dbox = function (type, msg, callback, defaultVal, opts, changeCb, checkbox) {
					    ...
					    if ($("#tool_make_link").attr("data-custom-typeProperties") == "true" && defaultVal == "http://") {
		...
		//	}
			...
			Actions = (function() {
				...
				var tool_buttons = [
                    ...
                    {
                        sel: '#tool_open', fn: function () {
                            dialogLoad();
                        }, evt: 'mouseup', key: ['O', true]
                    },///////////////////////////////////////////////////////
